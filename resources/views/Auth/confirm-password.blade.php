               ...
               <div class="row justify-content-center pt-5">
                  <div class="col-lg-8">
                        <div class="card d-flex justify-content-center mb-0">
                           <div class="card-body">
                              <h2 class="mb-2">Hi ! {{ Auth::user()->prenoms}}</h2>
                              <p>Veuillez entrer votre mot de passe pour pouvoir continuer</p>
                              @if ($errors->any())
                                 ...
                                 <div class="row">
                                    <div class="col-lg-12">
                                       <div class="floating-label form-group">
                                          ...
                                          <input type="password" class="form-control" name="password" aria-describedby="password" placeholder="xxxxxxx">
                                       </div>
                                    </div>
                                 </div>
