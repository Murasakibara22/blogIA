                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('dashboard/utilisateurs/liste') ? 'active':'' }}" href="/dashboard/utilisateurs/liste">
                                    <i class="icon">
                                        <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="../dashboard/blank-page.html">
                            ...
                            <span class="item-name">Regles de confidentialites</span>
                        </a>
                    </li>
                    <li>
                        <hr class="hr-horizontal">
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon">Parametres systemes</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui" role="button" aria-expanded="false"
                            ...
                            <span class="item-name">Intelligence Artificielle</span>
                            <i class="right-icon">
