                                    ...
                                    <li class="nav-item ">
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                            ...
                                            <li class="nav-item"><a class="nav-link active"
                                                    href="../dashboard/crypto-dashboard.html">Dashboard</a></li>
                                            <li class="nav-item"><a class="nav-link "
                                                    href="../dashboard/crypto-dashboard.html">IA</a></li>
                                            <li class="nav-item"><a class="nav-link active"
                                                    href="../dashboard/crypto-dashboard.html">BLogs</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting"
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title">{{ Auth::user()->prenoms.' '.Auth::user()->nom}}</h6>
                                        <p class="mb-0 caption-sub-title">{{Auth::user()->profession}}</p>
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                                    <li><a class="dropdown-item" href="../dashboard/app/user-profile.html">Mon Profile</a>
                                    </li>
                                    <li><a class="dropdown-item"
                                            href="../dashboard/app/user-privacy-setting.html">Privacy Reglages</a></li>
                                    <li>
