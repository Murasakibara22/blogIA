                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="d-flex align-items-center justify-content-between product-offcanvas">
                        <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Crypto</small>
                        </div>
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="homeData">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="menuStyles">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/index-horizontal.html">Horizontal
                                                            Dashboard</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/index-dual-compact.html">Dual Compact</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/index-boxed.html">Boxed Horizontal</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="allPagesData">
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="specialPages">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/special-pages/billing.html">Billing</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/special-pages/calender.html">Calender</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/special-pages/kanban.html">Kanban</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/special-pages/pricing.html">Pricing</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/special-pages/timeline.html">Timeline</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/auth/confirm-mail.html">Email
                                                            Verified</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/auth/recoverpw.html">Reset Password</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/auth/lock-screen.html">Lock Screen</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/auth/two-factor.html">Two Factor</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/auth/account-deactivate.html">Account
                                                            Deactivate</a></li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="userApps">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/app/user-profile.html">User Profile</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="utilities">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/errors/maintenance.html">Maintenance</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="extraPlugins">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/button-hover.html">Button
                                                            Hover</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/choise-js.html">Choise JS</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/fslightbox.html">FSlightbox</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/select2.html">Select2</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/sweet-alert.html">Sweetalert</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/flatpickr.html">flatpickr</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/apexcharts.html">Apexcharts</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/gallery-hover.html">Gallery
                                                            Hover</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/plugins/image-croper.html">Image
                                                            Croper</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                        ...
                                        <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="ui-element">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-avatars.html">Avatars</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-alerts.html">Alerts</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-badges.html">Badge</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-breadcrumb.html">Breadcrumb</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-buttons.html">Buttons</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-buttons-group.html">Buttons
                                                            Group</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-boxshadow.html">Box
                                                            Shadow</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-color.html">Colors</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-cards.html">Cards</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-carousel.html">Carousel</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-grid.html">Grid</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-images.html">Images</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-list-group.html">List
                                                            Group</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                    ...
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-pagination.html">Pagination</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-popovers.html">Popovers</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-typography.html">Typography</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-tabs.html">Tabs</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-tooltips.html">Tooltips</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/ui-elements/ui-embed-video.html">Video</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="widgetsPage">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/widget/widgetbasic.html">Widget Basic</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/widget/widgetchart.html">Widget Chart</a>
                                                    </li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/widget/widgetcard.html">Widget Card</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/form/form-validation.html">Validation</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
                                                ...
                                                <ul aria-expanded="false"
                                                    ...
                                                    id="tablesPages">
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/table/bootstrap-table.html">Bootstrap
                                                            Table</a></li>
                                                    <li class="nav-item"><a class="nav-link "
                                                            href="../dashboard/table/table-data.html">Data Table</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li class="nav-item">
